...
resource "aws_instance" "tf-docker-ec2" {
    ...
    security_groups = ["damla-docker-sec-gr-203"] # !!!!!!!!!!!!
    tags = {
        Name = "damla-Web Server of Bookstore"
    }
    user_data = <<-EOF
          #! /bin/bash
          yum update -y
          ...
          FOLDER="https://$TOKEN@raw.githubusercontent.com/damlab45/Docker-Projects/main/"
